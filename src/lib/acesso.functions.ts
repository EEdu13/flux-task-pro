 ...
 *
 * Quem GRAVA mora em `acesso.server.ts`, não aqui: é função comum, não server
 * function, e este arquivo é importado pela tela de Configurações. O corpo
 * dela viajaria inteiro para o navegador, com `getRequest` e o driver do SQL
 * Server a reboque.
 */
